...
public class FileCalculation implements Calculation {
    @Override
    public void minFlightTime(Tickets tickets, String originName, String destinationName) throws ParseException, IOException {
        ...
        throw new RuntimeException("The ticket list is empty; further execution is not possible.");
    }

    @Override
    public void diffBetweenAvePriceAndMediana(Tickets tickets, String originName, String destinationName) throws IOException {
        if (tickets.getTickets().size() > 0) {
            ...
            throw new RuntimeException("There are no tickets for a flight from " + originName + " to " + destinationName);
        }
        throw new RuntimeException("The ticket list is empty; further execution is not possible.");
    }
}
